...
Partial Class frmEditor_Shop
    ...
    Private Shared _instance As frmEditor_Shop

    ' Public property to get the shared instance
    Public Shared ReadOnly Property Instance() As frmEditor_Shop
        Get
    ...
    Private Sub InitializeComponent()
        ...
        CType(nudCostValue, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudItemValue, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudBuy, System.ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' DarkGroupBox1
        ' 
        ...
        CType(nudCostValue, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudItemValue, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudBuy, System.ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
