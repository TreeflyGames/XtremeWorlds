...
Partial Class frmEditor_Resource
    ...
    Private Shared _instance As frmEditor_Resource

    ' Public property to get the shared instance
    Public Shared ReadOnly Property Instance() As frmEditor_Resource
        Get
    ...
    Private Sub InitializeComponent()
        ...
        CType(nudRewardExp, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox4.SuspendLayout()
        CType(nudLvlReq, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudRespawn, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox3.SuspendLayout()
        CType(nudExhaustedPic, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudNormalPic, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picExhaustedPic, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picNormalpic, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudHealth, System.ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' DarkGroupBox1
        ' 
        ...
        CType(nudRewardExp, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox4.ResumeLayout(False)
        DarkGroupBox4.PerformLayout()
        CType(nudLvlReq, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudRespawn, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox3.ResumeLayout(False)
        DarkGroupBox3.PerformLayout()
        CType(nudExhaustedPic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudNormalPic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(picExhaustedPic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(picNormalpic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudHealth, System.ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
