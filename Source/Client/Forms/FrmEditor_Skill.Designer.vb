...
Partial Class frmEditor_Skill
    ...
    Private Shared _instance As frmEditor_Skill

    ' Public property to get the shared instance
    Public Shared ReadOnly Property Instance() As frmEditor_Skill
        Get
    ...
    Private Sub InitializeComponent()
        ...
        CType(nudStun, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudAoE, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudRange, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox7.SuspendLayout()
        CType(nudInterval, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudDuration, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudVital, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox6.SuspendLayout()
        CType(nudY, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudX, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudMap, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox3.SuspendLayout()
        CType(nudIcon, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picSprite, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudCool, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudCast, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox4.SuspendLayout()
        CType(nudLevel, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudMp, System.ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' DarkGroupBox1
        ' 
        ...
        CType(nudStun, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudAoE, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudRange, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(nudDuration, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudVital, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox6.ResumeLayout(False)
        DarkGroupBox6.PerformLayout()
        CType(nudY, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudX, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudMap, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(picSprite, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudCool, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudCast, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox4.ResumeLayout(False)
        DarkGroupBox4.PerformLayout()
        CType(nudLevel, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudMp, System.ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
    ...
    Friend WithEvents btnLearn As DarkUI.Controls.DarkButton
End Class
