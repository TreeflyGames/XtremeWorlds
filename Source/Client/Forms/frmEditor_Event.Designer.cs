...
namespace Client
{
    ...
    internal partial class frmEditor_Event : Form
    {
        ...
        {
            TreeNode treeNode62 = new TreeNode("Show Text");
            TreeNode treeNode63 = new TreeNode("Show Choices");
            TreeNode treeNode64 = new TreeNode("Add Chatbox Text");
            TreeNode treeNode65 = new TreeNode("Show ChatBubble");
            TreeNode treeNode66 = new TreeNode("Messages", new TreeNode[] { treeNode62, treeNode63, treeNode64, treeNode65 });
            TreeNode treeNode67 = new TreeNode("Set Player Variable");
            TreeNode treeNode68 = new TreeNode("Set Player Switch");
            TreeNode treeNode69 = new TreeNode("Set Self Switch");
            TreeNode treeNode70 = new TreeNode("Event Processing", new TreeNode[] { treeNode67, treeNode68, treeNode69 });
            TreeNode treeNode71 = new TreeNode("Conditional Branch");
            TreeNode treeNode72 = new TreeNode("Stop Event Processing");
            TreeNode treeNode73 = new TreeNode("Label");
            TreeNode treeNode74 = new TreeNode("GoTo Label");
            TreeNode treeNode75 = new TreeNode("Flow Control", new TreeNode[] { treeNode71, treeNode72, treeNode73, treeNode74 });
            TreeNode treeNode76 = new TreeNode("Change Items");
            TreeNode treeNode77 = new TreeNode("Restore HP");
            TreeNode treeNode78 = new TreeNode("Restore MP");
            TreeNode treeNode79 = new TreeNode("Level Up");
            TreeNode treeNode80 = new TreeNode("Change Level");
            TreeNode treeNode81 = new TreeNode("Change Skills");
            TreeNode treeNode82 = new TreeNode("Change Job");
            TreeNode treeNode83 = new TreeNode("Change Sprite");
            TreeNode treeNode84 = new TreeNode("Change Gender");
            TreeNode treeNode85 = new TreeNode("Change PK");
            TreeNode treeNode86 = new TreeNode("Give Experience");
            TreeNode treeNode87 = new TreeNode("Player Options", new TreeNode[] { treeNode76, treeNode77, treeNode78, treeNode79, treeNode80, treeNode81, treeNode82, treeNode83, treeNode84, treeNode85, treeNode86 });
            TreeNode treeNode88 = new TreeNode("Warp Player");
            TreeNode treeNode89 = new TreeNode("Set Move Route");
            TreeNode treeNode90 = new TreeNode("Wait for Route Completion");
            TreeNode treeNode91 = new TreeNode("Force Spawn NPC");
            TreeNode treeNode92 = new TreeNode("Hold Player");
            TreeNode treeNode93 = new TreeNode("Release Player");
            TreeNode treeNode94 = new TreeNode("Movement", new TreeNode[] { treeNode88, treeNode89, treeNode90, treeNode91, treeNode92, treeNode93 });
            TreeNode treeNode95 = new TreeNode("Animation");
            TreeNode treeNode96 = new TreeNode("Animation", new TreeNode[] { treeNode95 });
            TreeNode treeNode97 = new TreeNode("Begin Quest");
            TreeNode treeNode98 = new TreeNode("Complete Task");
            TreeNode treeNode99 = new TreeNode("End Quest");
            TreeNode treeNode100 = new TreeNode("Questing", new TreeNode[] { treeNode97, treeNode98, treeNode99 });
            TreeNode treeNode101 = new TreeNode("Set Fog");
            TreeNode treeNode102 = new TreeNode("Set Weather");
            TreeNode treeNode103 = new TreeNode("Set Map Tinting");
            TreeNode treeNode104 = new TreeNode("Map Functions", new TreeNode[] { treeNode101, treeNode102, treeNode103 });
            TreeNode treeNode105 = new TreeNode("Play BGM");
            TreeNode treeNode106 = new TreeNode("Stop BGM");
            TreeNode treeNode107 = new TreeNode("Play Sound");
            TreeNode treeNode108 = new TreeNode("Stop Sounds");
            TreeNode treeNode109 = new TreeNode("Music and Sound", new TreeNode[] { treeNode105, treeNode106, treeNode107, treeNode108 });
            TreeNode treeNode110 = new TreeNode("Wait...");
            TreeNode treeNode111 = new TreeNode("Set Access");
            TreeNode treeNode112 = new TreeNode("Custom Script");
            TreeNode treeNode113 = new TreeNode("Etc...", new TreeNode[] { treeNode110, treeNode111, treeNode112 });
            TreeNode treeNode114 = new TreeNode("Open Bank");
            TreeNode treeNode115 = new TreeNode("Open Shop");
            TreeNode treeNode116 = new TreeNode("Shop and Bank", new TreeNode[] { treeNode114, treeNode115 });
            TreeNode treeNode117 = new TreeNode("Fade In");
            TreeNode treeNode118 = new TreeNode("Fade Out");
            TreeNode treeNode119 = new TreeNode("Flash White");
            TreeNode treeNode120 = new TreeNode("Show Picture");
            TreeNode treeNode121 = new TreeNode("Hide Picture");
            TreeNode treeNode122 = new TreeNode("Cutscene Options", new TreeNode[] { treeNode117, treeNode118, treeNode119, treeNode120, treeNode121 });
            ListViewGroup listViewGroup10 = new ListViewGroup("Movement", HorizontalAlignment.Left);
            ListViewGroup listViewGroup11 = new ListViewGroup("Wait", HorizontalAlignment.Left);
            ListViewGroup listViewGroup12 = new ListViewGroup("Turning", HorizontalAlignment.Left);
            ListViewGroup listViewGroup13 = new ListViewGroup("Speed", HorizontalAlignment.Left);
            ListViewGroup listViewGroup14 = new ListViewGroup("Walk Animation", HorizontalAlignment.Left);
            ListViewGroup listViewGroup15 = new ListViewGroup("Fixed Direction", HorizontalAlignment.Left);
            ListViewGroup listViewGroup16 = new ListViewGroup("WalkThrough", HorizontalAlignment.Left);
            ListViewGroup listViewGroup17 = new ListViewGroup("Set Position", HorizontalAlignment.Left);
            ListViewGroup listViewGroup18 = new ListViewGroup("Set Graphic", HorizontalAlignment.Left);
            ListViewItem listViewItem44 = new ListViewItem("Move Up");
            ListViewItem listViewItem45 = new ListViewItem("Move Down");
            ListViewItem listViewItem46 = new ListViewItem("Move left");
            ListViewItem listViewItem47 = new ListViewItem("Move Right");
            ListViewItem listViewItem48 = new ListViewItem("Move Randomly");
            ListViewItem listViewItem49 = new ListViewItem("Move To Player***");
            ListViewItem listViewItem50 = new ListViewItem("Move from Player***");
            ListViewItem listViewItem51 = new ListViewItem("Step Forwards");
            ListViewItem listViewItem52 = new ListViewItem("Step Backwards");
            ListViewItem listViewItem53 = new ListViewItem("Wait 100Ms");
            ListViewItem listViewItem54 = new ListViewItem("Wait 500Ms");
            ListViewItem listViewItem55 = new ListViewItem("Wait 1000Ms");
            ListViewItem listViewItem56 = new ListViewItem("Turn Up");
            ListViewItem listViewItem57 = new ListViewItem("Turn Down");
            ListViewItem listViewItem58 = new ListViewItem("Turn Left");
            ListViewItem listViewItem59 = new ListViewItem("Turn Right");
            ListViewItem listViewItem60 = new ListViewItem("Turn 90DG Right");
            ListViewItem listViewItem61 = new ListViewItem("Turn 90DG Left");
            ListViewItem listViewItem62 = new ListViewItem("Turn 180DG");
            ListViewItem listViewItem63 = new ListViewItem("Turn Randomly");
            ListViewItem listViewItem64 = new ListViewItem("Turn To Player***");
            ListViewItem listViewItem65 = new ListViewItem("Turn From Player***");
            ListViewItem listViewItem66 = new ListViewItem("Set Speed 8x Slower");
            ListViewItem listViewItem67 = new ListViewItem("Set Speed 4x Slower");
            ListViewItem listViewItem68 = new ListViewItem("Set Speed 2x Slower");
            ListViewItem listViewItem69 = new ListViewItem("Set Speed To Normal");
            ListViewItem listViewItem70 = new ListViewItem("Set Speed 2x Faster");
            ListViewItem listViewItem71 = new ListViewItem("Set Speed 4x Faster");
            ListViewItem listViewItem72 = new ListViewItem("Set Freq. To Lowest");
            ListViewItem listViewItem73 = new ListViewItem("Set Freq. To Lower");
            ListViewItem listViewItem74 = new ListViewItem("Set Freq. To Normal");
            ListViewItem listViewItem75 = new ListViewItem("Set Freq. To Higher");
            ListViewItem listViewItem76 = new ListViewItem("Set Freq. To Highest");
            ListViewItem listViewItem77 = new ListViewItem("Walking Animation ON");
            ListViewItem listViewItem78 = new ListViewItem("Walking Animation OFF");
            ListViewItem listViewItem79 = new ListViewItem("Fixed Direction ON");
            ListViewItem listViewItem80 = new ListViewItem("Fixed Direction OFF");
            ListViewItem listViewItem81 = new ListViewItem("Walkthrough ON");
            ListViewItem listViewItem82 = new ListViewItem("Walkthrough ON");
            ListViewItem listViewItem83 = new ListViewItem("Set Position Below Player");
            ListViewItem listViewItem84 = new ListViewItem("Set PositionWith Player");
            ListViewItem listViewItem85 = new ListViewItem("Set Position Above Player");
            ListViewItem listViewItem86 = new ListViewItem("Set Graphic...");
