...
Partial Class frmEditor_Animation
    ...
    Private Shared _instance As frmEditor_Animation

    ' Public property to get the shared instance
    Public Shared ReadOnly Property Instance() As frmEditor_Animation
        Get
    ...
    Private Sub InitializeComponent()
        ...
        CType(nudLoopTime1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudFrameCount1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudLoopCount1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudSprite1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picSprite1, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox3.SuspendLayout()
        CType(nudLoopTime0, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudFrameCount0, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudLoopCount0, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudSprite0, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picSprite0, System.ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' DarkGroupBox1
        ' 
        ...
        CType(nudLoopTime1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudFrameCount1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudLoopCount1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudSprite1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(picSprite1, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox3.ResumeLayout(False)
        DarkGroupBox3.PerformLayout()
        CType(nudLoopTime0, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudFrameCount0, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudLoopCount0, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudSprite0, System.ComponentModel.ISupportInitialize).EndInit()
        CType(picSprite0, System.ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
