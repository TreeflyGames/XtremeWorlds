...
Partial Class frmEditor_Job
    ...
    Private Shared _instance As frmEditor_Job

    ' Public property to get the shared instance
    Public Shared ReadOnly Property Instance() As frmEditor_Job
        Get
    ...
    Private Sub InitializeComponent()
        ...
        CType(nudStartY, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudStartX, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(nudStartMap, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox6.SuspendLayout()
        CType(nudItemAmount, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox5.SuspendLayout()
        CType(nudBaseExp, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(nudFemaleSprite, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picFemale, System.ComponentModel.ISupportInitialize).BeginInit()
        DarkGroupBox3.SuspendLayout()
        CType(nudMaleSprite, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(picMale, System.ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' DarkGroupBox1
        ' 
        ...
        CType(nudStartY, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudStartX, System.ComponentModel.ISupportInitialize).EndInit()
        CType(nudStartMap, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox6.ResumeLayout(False)
        DarkGroupBox6.PerformLayout()
        CType(nudItemAmount, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox5.ResumeLayout(False)
        DarkGroupBox5.PerformLayout()
        CType(nudBaseExp, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(nudFemaleSprite, System.ComponentModel.ISupportInitialize).EndInit()
        CType(picFemale, System.ComponentModel.ISupportInitialize).EndInit()
        DarkGroupBox3.ResumeLayout(False)
        DarkGroupBox3.PerformLayout()
        CType(nudMaleSprite, System.ComponentModel.ISupportInitialize).EndInit()
        CType(picMale, System.ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
    End Sub
