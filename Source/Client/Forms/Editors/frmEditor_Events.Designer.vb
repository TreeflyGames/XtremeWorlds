...
Partial Class frmEditor_Events
    ...
    Private Sub InitializeComponent()
        Dim TreeNode62 As TreeNode = New TreeNode("Show Text")
        Dim TreeNode63 As TreeNode = New TreeNode("Show Choices")
        Dim TreeNode64 As TreeNode = New TreeNode("Add Chatbox Text")
        Dim TreeNode65 As TreeNode = New TreeNode("Show ChatBubble")
        Dim TreeNode66 As TreeNode = New TreeNode("Messages", New TreeNode() {TreeNode62, TreeNode63, TreeNode64, TreeNode65})
        Dim TreeNode67 As TreeNode = New TreeNode("Set Player Variable")
        Dim TreeNode68 As TreeNode = New TreeNode("Set Player Switch")
        Dim TreeNode69 As TreeNode = New TreeNode("Set Self Switch")
        Dim TreeNode70 As TreeNode = New TreeNode("Event Processing", New TreeNode() {TreeNode67, TreeNode68, TreeNode69})
        Dim TreeNode71 As TreeNode = New TreeNode("Conditional Branch")
        Dim TreeNode72 As TreeNode = New TreeNode("Stop Event Processing")
        Dim TreeNode73 As TreeNode = New TreeNode("Label")
        Dim TreeNode74 As TreeNode = New TreeNode("GoTo Label")
        Dim TreeNode75 As TreeNode = New TreeNode("Flow Control", New TreeNode() {TreeNode71, TreeNode72, TreeNode73, TreeNode74})
        Dim TreeNode76 As TreeNode = New TreeNode("Change Items")
        Dim TreeNode77 As TreeNode = New TreeNode("Restore HP")
        Dim TreeNode78 As TreeNode = New TreeNode("Restore MP")
        Dim TreeNode79 As TreeNode = New TreeNode("Level Up")
        Dim TreeNode80 As TreeNode = New TreeNode("Change Level")
        Dim TreeNode81 As TreeNode = New TreeNode("Change Skills")
        Dim TreeNode82 As TreeNode = New TreeNode("Change Job")
        Dim TreeNode83 As TreeNode = New TreeNode("Change Sprite")
        Dim TreeNode84 As TreeNode = New TreeNode("Change Gender")
        Dim TreeNode85 As TreeNode = New TreeNode("Change PK")
        Dim TreeNode86 As TreeNode = New TreeNode("Give Experience")
        Dim TreeNode87 As TreeNode = New TreeNode("Player Options", New TreeNode() {TreeNode76, TreeNode77, TreeNode78, TreeNode79, TreeNode80, TreeNode81, TreeNode82, TreeNode83, TreeNode84, TreeNode85, TreeNode86})
        Dim TreeNode88 As TreeNode = New TreeNode("Warp Player")
        Dim TreeNode89 As TreeNode = New TreeNode("Set Move Route")
        Dim TreeNode90 As TreeNode = New TreeNode("Wait for Route Completion")
        Dim TreeNode91 As TreeNode = New TreeNode("Force Spawn Npc")
        Dim TreeNode92 As TreeNode = New TreeNode("Hold Player")
        Dim TreeNode93 As TreeNode = New TreeNode("Release Player")
        Dim TreeNode94 As TreeNode = New TreeNode("Movement", New TreeNode() {TreeNode88, TreeNode89, TreeNode90, TreeNode91, TreeNode92, TreeNode93})
        Dim TreeNode95 As TreeNode = New TreeNode("Animation")
        Dim TreeNode96 As TreeNode = New TreeNode("Animation", New TreeNode() {TreeNode95})
        Dim TreeNode97 As TreeNode = New TreeNode("Begin Quest")
        Dim TreeNode98 As TreeNode = New TreeNode("Complete Task")
        Dim TreeNode99 As TreeNode = New TreeNode("End Quest")
        Dim TreeNode100 As TreeNode = New TreeNode("Questing", New TreeNode() {TreeNode97, TreeNode98, TreeNode99})
        Dim TreeNode101 As TreeNode = New TreeNode("Set Fog")
        Dim TreeNode102 As TreeNode = New TreeNode("Set Weather")
        Dim TreeNode103 As TreeNode = New TreeNode("Set Map Tinting")
        Dim TreeNode104 As TreeNode = New TreeNode("Map Functions", New TreeNode() {TreeNode101, TreeNode102, TreeNode103})
        Dim TreeNode105 As TreeNode = New TreeNode("Play BGM")
        Dim TreeNode106 As TreeNode = New TreeNode("Stop BGM")
        Dim TreeNode107 As TreeNode = New TreeNode("Play Sound")
        Dim TreeNode108 As TreeNode = New TreeNode("Stop Sounds")
        Dim TreeNode109 As TreeNode = New TreeNode("Music and Sound", New TreeNode() {TreeNode105, TreeNode106, TreeNode107, TreeNode108})
        Dim TreeNode110 As TreeNode = New TreeNode("Wait...")
        Dim TreeNode111 As TreeNode = New TreeNode("Set Access")
        Dim TreeNode112 As TreeNode = New TreeNode("Custom Script")
        Dim TreeNode113 As TreeNode = New TreeNode("Etc...", New TreeNode() {TreeNode110, TreeNode111, TreeNode112})
        Dim TreeNode114 As TreeNode = New TreeNode("Open Bank")
        Dim TreeNode115 As TreeNode = New TreeNode("Open Shop")
        Dim TreeNode116 As TreeNode = New TreeNode("Shop and Bank", New TreeNode() {TreeNode114, TreeNode115})
        Dim TreeNode117 As TreeNode = New TreeNode("Fade In")
        Dim TreeNode118 As TreeNode = New TreeNode("Fade Out")
        Dim TreeNode119 As TreeNode = New TreeNode("Flash White")
        Dim TreeNode120 As TreeNode = New TreeNode("Show Picture")
        Dim TreeNode121 As TreeNode = New TreeNode("Hide Picture")
        Dim TreeNode122 As TreeNode = New TreeNode("Cutscene Options", New TreeNode() {TreeNode117, TreeNode118, TreeNode119, TreeNode120, TreeNode121})
        Dim ListViewGroup10 As ListViewGroup = New ListViewGroup("Movement", HorizontalAlignment.Left)
        Dim ListViewGroup11 As ListViewGroup = New ListViewGroup("Wait", HorizontalAlignment.Left)
        Dim ListViewGroup12 As ListViewGroup = New ListViewGroup("Turning", HorizontalAlignment.Left)
        Dim ListViewGroup13 As ListViewGroup = New ListViewGroup("Speed", HorizontalAlignment.Left)
        Dim ListViewGroup14 As ListViewGroup = New ListViewGroup("Walk Animation", HorizontalAlignment.Left)
        Dim ListViewGroup15 As ListViewGroup = New ListViewGroup("Fixed Direction", HorizontalAlignment.Left)
        Dim ListViewGroup16 As ListViewGroup = New ListViewGroup("WalkThrough", HorizontalAlignment.Left)
        Dim ListViewGroup17 As ListViewGroup = New ListViewGroup("Set Position", HorizontalAlignment.Left)
        Dim ListViewGroup18 As ListViewGroup = New ListViewGroup("Set Graphic", HorizontalAlignment.Left)
        Dim ListViewItem44 As ListViewItem = New ListViewItem("Move Up")
        Dim ListViewItem45 As ListViewItem = New ListViewItem("Move Down")
        Dim ListViewItem46 As ListViewItem = New ListViewItem("Move left")
        Dim ListViewItem47 As ListViewItem = New ListViewItem("Move Right")
        Dim ListViewItem48 As ListViewItem = New ListViewItem("Move Randomly")
        Dim ListViewItem49 As ListViewItem = New ListViewItem("Move To Player***")
        Dim ListViewItem50 As ListViewItem = New ListViewItem("Move from Player***")
        Dim ListViewItem51 As ListViewItem = New ListViewItem("Step Forwards")
        Dim ListViewItem52 As ListViewItem = New ListViewItem("Step Backwards")
        Dim ListViewItem53 As ListViewItem = New ListViewItem("Wait 100Ms")
        Dim ListViewItem54 As ListViewItem = New ListViewItem("Wait 500Ms")
        Dim ListViewItem55 As ListViewItem = New ListViewItem("Wait 1000Ms")
        Dim ListViewItem56 As ListViewItem = New ListViewItem("Turn Up")
        Dim ListViewItem57 As ListViewItem = New ListViewItem("Turn Down")
        Dim ListViewItem58 As ListViewItem = New ListViewItem("Turn Left")
        Dim ListViewItem59 As ListViewItem = New ListViewItem("Turn Right")
        Dim ListViewItem60 As ListViewItem = New ListViewItem("Turn 90DG Right")
        Dim ListViewItem61 As ListViewItem = New ListViewItem("Turn 90DG Left")
        Dim ListViewItem62 As ListViewItem = New ListViewItem("Turn 180DG")
        Dim ListViewItem63 As ListViewItem = New ListViewItem("Turn Randomly")
        Dim ListViewItem64 As ListViewItem = New ListViewItem("Turn To Player***")
        Dim ListViewItem65 As ListViewItem = New ListViewItem("Turn From Player***")
        Dim ListViewItem66 As ListViewItem = New ListViewItem("Set Speed 8x Slower")
        Dim ListViewItem67 As ListViewItem = New ListViewItem("Set Speed 4x Slower")
        Dim ListViewItem68 As ListViewItem = New ListViewItem("Set Speed 2x Slower")
        Dim ListViewItem69 As ListViewItem = New ListViewItem("Set Speed To Normal")
        Dim ListViewItem70 As ListViewItem = New ListViewItem("Set Speed 2x Faster")
        Dim ListViewItem71 As ListViewItem = New ListViewItem("Set Speed 4x Faster")
        Dim ListViewItem72 As ListViewItem = New ListViewItem("Set Freq. To Lowest")
        Dim ListViewItem73 As ListViewItem = New ListViewItem("Set Freq. To Lower")
        Dim ListViewItem74 As ListViewItem = New ListViewItem("Set Freq. To Normal")
        Dim ListViewItem75 As ListViewItem = New ListViewItem("Set Freq. To Higher")
        Dim ListViewItem76 As ListViewItem = New ListViewItem("Set Freq. To Highest")
        Dim ListViewItem77 As ListViewItem = New ListViewItem("Walking Animation ON")
        Dim ListViewItem78 As ListViewItem = New ListViewItem("Walking Animation OFF")
        Dim ListViewItem79 As ListViewItem = New ListViewItem("Fixed Direction ON")
        Dim ListViewItem80 As ListViewItem = New ListViewItem("Fixed Direction OFF")
        Dim ListViewItem81 As ListViewItem = New ListViewItem("Walkthrough ON")
        Dim ListViewItem82 As ListViewItem = New ListViewItem("Walkthrough ON")
        Dim ListViewItem83 As ListViewItem = New ListViewItem("Set Position Below Player")
        Dim ListViewItem84 As ListViewItem = New ListViewItem("Set PositionWith Player")
        Dim ListViewItem85 As ListViewItem = New ListViewItem("Set Position Above Player")
        Dim ListViewItem86 As ListViewItem = New ListViewItem("Set Graphic...")
        ...
        TreeNode62.Text = "Show Text"
        TreeNode63.Name = "Node2"
        TreeNode63.Text = "Show Choices"
        TreeNode64.Name = "Node3"
        TreeNode64.Text = "Add Chatbox Text"
        TreeNode65.Name = "Node5"
        TreeNode65.Text = "Show ChatBubble"
        TreeNode66.Name = "NodeMessages"
        TreeNode66.Text = "Messages"
        TreeNode67.Name = "Node1"
        TreeNode67.Text = "Set Player Variable"
        TreeNode68.Name = "Node2"
        TreeNode68.Text = "Set Player Switch"
        TreeNode69.Name = "Node3"
        TreeNode69.Text = "Set Self Switch"
        TreeNode70.Name = "NodeProcessing"
        TreeNode70.Text = "Event Processing"
        TreeNode71.Name = "Node1"
        TreeNode71.Text = "Conditional Branch"
        TreeNode72.Name = "Node2"
        TreeNode72.Text = "Stop Event Processing"
        TreeNode73.Name = "Node3"
        TreeNode73.Text = "Label"
        TreeNode74.Name = "Node4"
        TreeNode74.Text = "GoTo Label"
        TreeNode75.Name = "NodeFlowControl"
        TreeNode75.Text = "Flow Control"
        TreeNode76.Name = "Node1"
        TreeNode76.Text = "Change Items"
        TreeNode77.Name = "Node2"
        TreeNode77.Text = "Restore HP"
        TreeNode78.Name = "Node3"
        TreeNode78.Text = "Restore MP"
        TreeNode79.Name = "Node4"
        TreeNode79.Text = "Level Up"
        TreeNode80.Name = "Node5"
        TreeNode80.Text = "Change Level"
        TreeNode81.Name = "Node6"
        TreeNode81.Text = "Change Skills"
        TreeNode82.Name = "Node7"
        TreeNode82.Text = "Change Job"
        TreeNode83.Name = "Node8"
        TreeNode83.Text = "Change Sprite"
        TreeNode84.Name = "Node9"
        TreeNode84.Text = "Change Gender"
        TreeNode85.Name = "Node10"
        TreeNode85.Text = "Change PK"
        TreeNode86.Name = "Node11"
        TreeNode86.Text = "Give Experience"
        TreeNode87.Name = "NodePlayerOptions"
        TreeNode87.Text = "Player Options"
        TreeNode88.Name = "Node1"
        TreeNode88.Text = "Warp Player"
        TreeNode89.Name = "Node2"
        TreeNode89.Text = "Set Move Route"
        TreeNode90.Name = "Node3"
        TreeNode90.Text = "Wait for Route Completion"
        TreeNode91.Name = "Node4"
        TreeNode91.Text = "Force Spawn Npc"
        TreeNode92.Name = "Node5"
        TreeNode92.Text = "Hold Player"
        TreeNode93.Name = "Node6"
        TreeNode93.Text = "Release Player"
        TreeNode94.Name = "NodeMovement"
        TreeNode94.Text = "Movement"
        TreeNode95.Name = "Node1"
        TreeNode95.Text = "Animation"
        TreeNode96.Name = "NodeAnimation"
        TreeNode96.Text = "Animation"
        TreeNode97.Name = "Node1"
        TreeNode97.Text = "Begin Quest"
        TreeNode98.Name = "Node2"
        TreeNode98.Text = "Complete Task"
        TreeNode99.Name = "Node3"
        TreeNode99.Text = "End Quest"
        TreeNode100.Name = "NodeQuesting"
        TreeNode100.Text = "Questing"
        TreeNode101.Name = "Node1"
        TreeNode101.Text = "Set Fog"
        TreeNode102.Name = "Node2"
        TreeNode102.Text = "Set Weather"
        TreeNode103.Name = "Node3"
        TreeNode103.Text = "Set Map Tinting"
        TreeNode104.Name = "NodeMapFunctions"
        TreeNode104.Text = "Map Functions"
        TreeNode105.Name = "Node1"
        TreeNode105.Text = "Play BGM"
        TreeNode106.Name = "Node2"
        TreeNode106.Text = "Stop BGM"
        TreeNode107.Name = "Node3"
        TreeNode107.Text = "Play Sound"
        TreeNode108.Name = "Node4"
        TreeNode108.Text = "Stop Sounds"
        TreeNode109.Name = "NodeSound"
        TreeNode109.Text = "Music and Sound"
        TreeNode110.Name = "Node1"
        TreeNode110.Text = "Wait..."
        TreeNode111.Name = "Node2"
        TreeNode111.Text = "Set Access"
        TreeNode112.Name = "Node3"
        TreeNode112.Text = "Custom Script"
        TreeNode113.Name = "NodeEtc"
        TreeNode113.Text = "Etc..."
        TreeNode114.Name = "Node1"
        TreeNode114.Text = "Open Bank"
        TreeNode115.Name = "Node2"
        TreeNode115.Text = "Open Shop"
        TreeNode116.Name = "NodeShopBank"
        TreeNode116.Text = "Shop and Bank"
        TreeNode117.Name = "Node1"
        TreeNode117.Text = "Fade In"
        TreeNode118.Name = "Node2"
        TreeNode118.Text = "Fade Out"
        TreeNode119.Name = "Node12"
        TreeNode119.Text = "Flash White"
        TreeNode120.Name = "Node13"
        TreeNode120.Text = "Show Picture"
        TreeNode121.Name = "Node14"
        TreeNode121.Text = "Hide Picture"
        TreeNode122.Name = "Node0"
        TreeNode122.Text = "Cutscene Options"
        tvCommands.Nodes.AddRange(New TreeNode() {TreeNode66, TreeNode70, TreeNode75, TreeNode87, TreeNode94, TreeNode96, TreeNode100, TreeNode104, TreeNode109, TreeNode113, TreeNode116, TreeNode122})
        ...
        lstvwMoveRoute.Groups.AddRange(New ListViewGroup() {ListViewGroup10, ListViewGroup11, ListViewGroup12, ListViewGroup13, ListViewGroup14, ListViewGroup15, ListViewGroup16, ListViewGroup17, ListViewGroup18})
