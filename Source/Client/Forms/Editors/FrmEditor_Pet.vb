...
#Region "Basics"
    ...
    Private Sub TxtName_TextChanged(sender As Object, e As EventArgs) Handles txtName.TextChanged
        ...
        Type.Pet(EditorIndex).Name = txtName.Text
        lstIndex.Items.RemoveAt(EditorIndex - 1)
        lstIndex.Items.Insert(EditorIndex - 1, EditorIndex & ": " & Type.Pet(EditorIndex).Name)
        lstIndex.SelectedIndex = tmpindex
    End Sub

    Private Sub NudSprite_Click(sender As Object, e As EventArgs) Handles nudSprite.Click
        Type.Pet(EditorIndex).Sprite = nudSprite.Value
    ...
    Friend Sub EditorPet_DrawPet()
        ...
        If File.Exists(Core.Path.Graphics & "Characters\" & petnum & GfxExt) Then
            picSprite.Width = Drawing.Image.FromFile(Core.Path.Graphics & "characters\" & petnum & GfxExt).Width/4
            picSprite.Height = Drawing.Image.FromFile(Core.Path.Graphics & "characters\" & petnum & GfxExt).Height/4
            picSprite.BackgroundImage = Image.FromFile(Core.Path.Graphics & "Characters\" & petnum & GfxExt)
        Else
            picSprite.BackgroundImage = Nothing
        End If
    ...
    Private Sub NudRange_ValueChanged(sender As Object, e As EventArgs) Handles nudRange.Click
        Type.Pet(EditorIndex).Range = nudRange.Value
    End Sub
...
#Region "Stats"
    ...
    Private Sub OptCustomStats_CheckedChanged(sender As Object, e As EventArgs) Handles optCustomStats.CheckedChanged
        If optCustomStats.Checked = True Then
            ...
            Type.Pet(EditorIndex).StatType = 1
        Else
            pnlCustomStats.Visible = False
            Type.Pet(EditorIndex).StatType = 0
        End If
    End Sub
...
#Region "Leveling"
    ...
    Private Sub OptLevel_CheckedChanged(sender As Object, e As EventArgs) Handles optLevel.Click
        If optLevel.Checked = True Then
            ...
            Type.Pet(EditorIndex).LevelingType = 1
        End If
    End Sub
    ...
    Private Sub OptDoNotLevel_CheckedChanged(sender As Object, e As EventArgs) Handles optDoNotLevel.Click
        If optDoNotLevel.Checked = True Then
            ...
            Type.Pet(EditorIndex).LevelingType = 0
        End If
    End Sub
