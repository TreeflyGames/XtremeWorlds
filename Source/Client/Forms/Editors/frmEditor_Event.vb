...
#Region "Frm"
    ...
    Sub ClearConditionFrame()
        ...
        For i = 1 To MAX_ITEMS
            cmbCondition_HasItem.Items.Add(i & ". " & Type.Item(i).Name)
        Next
        ...
        For i = 1 To MAX_JOBS
            cmbCondition_JobIs.Items.Add(i & ". " & Type.Job(i).Name)
        Next
        ...
        For i = 1 To MAX_SKILLS
            cmbCondition_LearntSkill.Items.Add(i & ". " &Type.Skill(i).Name)
        Next
    ...
    Private Sub frmEditor_Event_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim i As Integer
        ...
        For i = 1 To MAX_ITEMS
            cmbChangeItemIndex.Items.Add(Type.Item(i).Name)
        Next
        ...
        For i = 1 To MAX_SKILLS
            cmbChangeSkills.Items.Add(Type.Skill(i).Name)
        Next
        ...
        For i = 1 To MAX_JOBS
            cmbChangeJob.Items.Add(Type.Job(i).Name)
        Next
        ...
        For i = 1 To MAX_ANIMATIONS
            cmbPlayAnim.Items.Add(i & ". " & Type.Animation(i).Name)
        Next
        ...
        For i = 1 To MAX_SHOPS
            cmbOpenShop.Items.Add(i & ". " & Type.Shop(i).Name)
        Next
        ...
        For i = 1 To MAX_MAP_NPCS
            If MyMap.NPC(i) > 0 Then
                cmbSpawnNpc.Items.Add(i & ". " & Type.NPC(MyMapNPC(i).Num).Name)
            Else
        ...
        For i = 1 To MAX_ITEMS
            cmbHasItem.Items.Add(i & ": " & Type.Item(i).Name)
        Next
    ...
    Private Sub frmEditor_Event_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        TmpEvent = Nothing
    End Sub
    ...
    Private Sub TvCommands_AfterSelect(sender As Object, e As TreeViewEventArgs) Handles tvCommands.AfterSelect
        ...
        'Movement
            ...
            Case "Set Move Route"
                ...
                For i = 0 To MyMap.EventCount
                    If i <> EditorEvent Then
                        cmbEvent.Items.Add(MyMap.Event(i).Name)
                        x = x + 1
                        ListOfEvents(x) = i
                    End If
                Next
            ...
            Case "Wait for Route Completion"
                ...
                For i = 0 To MyMap.EventCount
                    If i <> EditorEvent Then
                        cmbMoveWait.Items.Add(MyMap.Event(i).Name)
                        x = x + 1
                        ListOfEvents(x) = i
                    End If
                Next
            ...
            Case "Force Spawn Npc"
                ...
                cmbSpawnNpc.Items.Clear()
                For i = 1 To MAX_NPCS
                    cmbSpawnNpc.Items.Add(Type.NPC(i).Name)
                Next
                cmbSpawnNpc.SelectedIndex = 0
                fraDialogue.Visible = True
        ...
        'Animation
            ...
            Case "Play Animation"
                ...
                For i = 0 To MyMap.EventCount
                    cmbPlayAnimEvent.Items.Add(i & ". " & MyMap.Event(i).Name)
                Next
                ...
                nudPlayAnimTileX.Maximum = MyMap.MaxX
                nudPlayAnimTileY.Maximum = MyMap.MaxY
                fraDialogue.Visible = True
...
#Region "Graphic"
    ...
    Private Sub PicGraphicSel_Click(sender As Object, e As MouseEventArgs)
        ...
        ElseIf cmbGraphic.SelectedIndex = 1 Then
            ...
            For i = 0 To 3
                If GraphicSelX >= Client.CharacterGfxInfo(nudGraphic.Value).Width / 4 * i And GraphicSelX < Client.CharacterGfxInfo(nudGraphic.Value).Width / 4 * (i + 1) Then
                    GraphicSelX = i
                End If
            Next
            For i = 0 To 3
                If GraphicSelY >= Client.CharacterGfxInfo(nudGraphic.Value).Height / 4 * i And GraphicSelY < Client.CharacterGfxInfo(nudGraphic.Value).Height / 4 * (i + 1) Then
                    GraphicSelY = i
                End If
            Next
        End If
...
#Region "Variables/Switches"
    ...
    Private Sub BtnLabeling_Click(sender As Object, e As EventArgs) Handles btnLabeling.Click
        ...
        For i = 1 To MAX_SWITCHES
            lstSwitches.Items.Add(CStr(i) & ". " & Switches(i))
        Next
        lstVariables.Items.Clear()
        lstVariables.Items.Add("None")

        For i = 1 To NAX_VARIABLES
            lstVariables.Items.Add(CStr(i) & ". " & Variables(i))
        Next
    ...
    Private Sub CmbChatBubbleTargetType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbChatBubbleTargetType.SelectedIndexChanged
        ...
        ElseIf cmbChatBubbleTargetType.SelectedIndex = TargetType.Player Then
            ...
            For i = 1 To MAX_MAP_NPCS
                ...
                Else
                    cmbChatBubbleTarget.Items.Add(i & ". " & Type.NPC(MyMap.NPC(i)).Name)
                End If
            Next
        ...
        ElseIf cmbChatBubbleTargetType.SelectedIndex = TargetType.NPC Then
            ...
            For i = 0 To MyMap.EventCount
                cmbChatBubbleTarget.Items.Add(i & ". " & MyMap.Event(i).Name)
            Next
            cmbChatBubbleTarget.SelectedIndex = 0
        End If
