...
Friend Module C_Gui
        ...
        If HudVisible AndAlso HideGui = False Then
            If AboveActionPanel(x, y) Then
                ...
                If e.Button = MouseButtons.Left Then
                    'Inventory
                    If x > ActionPanelX + InvBtnX AndAlso x < ActionPanelX + InvBtnX + 46 AndAlso y > ActionPanelY + InvBtnY AndAlso y < ActionPanelY + InvBtnY + 46 Then
                        PlaySound("Click.ogg")
                    ...
                    ElseIf x > ActionPanelX + SkillBtnX AndAlso x < ActionPanelX + SkillBtnX + 46 AndAlso y > ActionPanelY + SkillBtnY AndAlso y < ActionPanelY + SkillBtnY + 46 Then
                        ...
                        CheckGuiClick = True
                        'Char
                    ElseIf x > ActionPanelX + CharBtnX AndAlso x < ActionPanelX + CharBtnX + 46 AndAlso y > ActionPanelY + CharBtnY AndAlso y < ActionPanelY + CharBtnY + 46 Then
                        PlaySound("Click.ogg")
                        ...
                        CheckGuiClick = True
                        'Quest
                    ElseIf x > ActionPanelX + OptBtnX AndAlso x < ActionPanelX + OptBtnX + 46 AndAlso y > ActionPanelY + OptBtnY AndAlso y < ActionPanelY + OptBtnY + 46 Then
                        PlaySound("Click.ogg")
                        PnlCharacterVisible = False
                        PnlInventoryVisible = False
                        PnlSkillsVisible = False
                        ...
                        CheckGuiClick = True
                        'Exit
                    ElseIf x > ActionPanelX + ExitBtnX AndAlso x < ActionPanelX + ExitBtnX + 46 AndAlso y > ActionPanelY + ExitBtnY AndAlso y < ActionPanelY + ExitBtnY + 46 Then
                        PlaySound("Click.ogg")
                        FrmAdmin.Dispose()
                        SendLeaveGame()
            ...
            If AboveHotbar(x, y) Then
                ...
                ElseIf e.Button = MouseButtons.Right Then ' right click
                    If Player(Myindex).Hotbar(hotbarslot).Slot > 0 Then
                        'forget hotbar skill
                        Dim result1 As DialogResult = MessageBox.Show("Want to Delete this from your hotbar?", Types.Settings.GameName, MessageBoxButtons.YesNo)
        ...
        If PnlCharacterVisible Then
            If AboveCharpanel(x, y) Then
                ...
                ElseIf e.Button = MouseButtons.Right Then
                    ...
                    If eqNum <> 0 Then
                        PlaySound("Click.ogg")
                        Dim result1 As DialogResult = MessageBox.Show("Want to Unequip this?", Types.Settings.GameName, MessageBoxButtons.YesNo)
                        If result1 = DialogResult.Yes Then
                            SendUnequip(eqNum)
                        End If
                        CheckGuiClick = True
    ...
    Friend Function CheckGuiMouseUp(x As Integer, y As Integer, e As MouseEventArgs) As Boolean
        Dim i As Integer, recPos As Rectangle
        ...
        If PnlSkillsVisible = True Then
            If AboveSkillpanel(x, y) Then
                ...
                ElseIf e.Button = MouseButtons.Right Then ' right click
                    ...
                    If skillnum <> 0 Then
                        Dim result1 As DialogResult = MessageBox.Show("Want to forget this skill?", Types.Settings.GameName, MessageBoxButtons.YesNo)
                        If result1 = DialogResult.Yes Then
