...
Public Class InputsDef
    ...
    Public Function MoveUp(keyCode As Keyboard.Key) As Boolean
    ...
    Public Function MoveDown(keyCode As Keyboard.Key) As Boolean
    ...
    Public Function MoveLeft(keyCode As Keyboard.Key) As Boolean
    ...
    Public Function MoveRight(keyCode As Keyboard.Key) As Boolean
