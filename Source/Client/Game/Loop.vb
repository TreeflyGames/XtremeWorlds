...
Module [Loop]
    ...
    Private tmr1000 As Integer
    Private tick As Integer
    Private fogtmr As Integer
    Private chattmr As Integer
    Private tmpfps As Integer
    Private tmplps As Integer
    Private walkTimer As Integer
    Private frameTime As Integer
    Private tmrweather As Integer
    Private barTmr As Integer
    Private tmr25 As Integer
    Private tmr500 As Integer
    Private tmr250 As Integer
    Private tmrconnect As Integer
    Private TickFPS As Integer
    Private fadetmr As Integer
    Private rendertmr As Integer
