...
namespace Client
{
    ...
    static class Sound
    {
        ...
        public static void PlayMusic(string fileName)
        {
            ...
            if (Conversions.ToInteger(Settings.Music) == 0 | !File.Exists(path))
            {
                StopMusic();
                return;
            }
            ...
            try
            {
                ...
                if (MusicStream != 0)
                {
                    ...
                    Bass.ChannelSetAttribute(MusicStream, ChannelAttribute.Volume, Settings.MusicVolume / 100.0f);
                    CurrentMusic = fileName;
        ...
        {
            if (Conversions.ToInteger(Settings.Sound) == 0 | !File.Exists(Core.Path.Sounds + fileName))
                return;
        ...
        public static void PlayExtraSound(string fileName, bool looped = false)
        {
            ...
            try
            {
                ...
                {
                    Bass.ChannelSetAttribute(ExtraSoundStream, ChannelAttribute.Volume, Settings.SoundVolume / 100.0f);
        ...
        public static void FadeIn()
        {
            if (MusicStream != 0)
            {
                ...
                if (currentVolume < Settings.MusicVolume / 100.0f)
                {
        ...
        public static double CalculateSoundVolume(ref int x, ref int y)
        {
            ...
            {
                CalculateSoundVolumeRet = 1d;
                CalculateSoundVolumeRet *= Settings.SoundVolume;
                return CalculateSoundVolumeRet;
            }
        ...
        public static void PlayWeatherSound(string fileName, bool looped = false)
        {
            ...
            if (!(Conversions.ToInteger(Settings.Sound) == 1) | !File.Exists(Core.Path.Sounds + fileName))
                return;
            ...
            {
                // Play the sound
                Bass.ChannelSetAttribute(WeatherStream, ChannelAttribute.Volume, Settings.SoundVolume / 100.0f);
