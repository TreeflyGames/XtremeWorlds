...
#Region "Ban"
    ...
    Sub ServerBanIndex(BanPlayerindex As Integer)
        ...
        GlobalMsg(GetPlayerName(BanPlayerindex) & " has been banned from " & Type.Setting.GameName & " by " & "the Server" & "!")
    ...
    Sub BanIndex(BanPlayerindex As Integer, BannedByindex As Integer)
        ...
        IP = Mid$(IP, 1, i)
        AddTextToFile(IP, "banlist.txt")
        GlobalMsg(GetPlayerName(BanPlayerindex) & " has been banned from " & Type.Setting.GameName & " by " & GetPlayerName(BannedByindex) & "!")
