        ...
        Select Case dir
            Case DirectionType.Up
                ...
                If y > 0 Then
                    ...
                    If IsDirBlocked(Map(mapNum).Tile(x, y).DirBlock, DirectionType.Up) Then
                        CanEventMove = False
                        Exit Function
                    End If
                Else
            ...
            Case DirectionType.Down
                ...
                If y < Map(mapNum).MaxY Then
                    ...
                    ' Directional blocking
                    If IsDirBlocked(Map(mapNum).Tile(x, y).DirBlock, DirectionType.Down) Then
                        CanEventMove = False
                        Exit Function
                    End If
                Else
            ...
            Case DirectionType.Left
                ...
                If x > 0 Then
                    ...
                    ' Directional blocking
                    If IsDirBlocked(Map(mapNum).Tile(x, y).DirBlock, DirectionType.Left) Then
                        CanEventMove = False
                        Exit Function
                    End If
                Else
            ...
            Case DirectionType.Right
                ...
                If x < Map(mapNum).MaxX Then
                    ...
                    ' Directional blocking
                    If IsDirBlocked(Map(mapNum).Tile(x, y).DirBlock, DirectionType.Right) Then
                        CanEventMove = False
                        Exit Function
                    End If
                Else
