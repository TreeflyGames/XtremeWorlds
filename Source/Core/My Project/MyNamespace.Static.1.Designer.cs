...
' Define compilation constants for different application types
...
#ElseIf _MYTYPE = "WebControl" Then
    ...
    #Const _MYUSERTYPE = "Web"
    #Const _MYCOMPUTERTYPE = "Web"
#ElseIf _MYTYPE = "AspNetCore" Then
    #Const _MYFORMS = False
    #Const _MYWEBSERVICES = True
    #Const _MYUSERTYPE = "AspNetCore"
    #Const _MYCOMPUTERTYPE = "Web"
    #Const _MYAPPLICATIONTYPE = "AspNetCore"
#ElseIf _MYTYPE = "Custom" Then
    ' Custom constants can be defined here
...
Namespace MergedMyNamespace50E26D7D27174AAEABCA70DEBD52E2FA
    ...
    ' MyApplication class for specific application types
    ...
    ' MyProject module with enhanced features
    <Global.Microsoft.VisualBasic.HideModuleName()> _
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("MyTemplate", "11.0.0.0")> _
    Friend Module MyProject

        ' ASP.NET Core specific initialization and properties
        #If _MYTYPE = "AspNetCore" Then
            Private _serviceProvider As Global.Microsoft.Extensions.DependencyInjection.IServiceProvider

            ''' <summary>
            ''' Initializes the MyProject module with the ASP.NET Core service provider.
            ''' Must be called during application startup (e.g., in Program.cs or Startup.cs).
            ''' </summary>
            Friend Sub Initialize(serviceProvider As Global.Microsoft.Extensions.DependencyInjection.IServiceProvider)
                _serviceProvider = serviceProvider
            End Sub

            ''' <summary>
            ''' Gets the current HTTP context for the request in an ASP.NET Core application.
            ''' </summary>
            <Global.System.ComponentModel.Design.HelpKeyword("My.HttpContext")> _
            Friend ReadOnly Property HttpContext() As Global.Microsoft.AspNetCore.Http.HttpContext
                <Global.System.Diagnostics.DebuggerHidden()> _
                Get
                    Dim accessor = _serviceProvider?.GetService(Of Global.Microsoft.AspNetCore.Http.IHttpContextAccessor)()
                    Return accessor?.HttpContext
                End Get
            End Property

            ''' <summary>
            ''' Gets the configuration instance for an ASP.NET Core application.
            ''' </summary>
            <Global.System.ComponentModel.Design.HelpKeyword("My.Configuration")> _
            Friend ReadOnly Property Configuration() As Global.Microsoft.Extensions.Configuration.IConfiguration
                <Global.System.Diagnostics.DebuggerHidden()> _
                Get
                    Return _serviceProvider?.GetService(Of Global.Microsoft.Extensions.Configuration.IConfiguration)()
                End Get
            End Property

            ''' <summary>
            ''' Gets a logger instance for logging in an ASP.NET Core application.
            ''' </summary>
            <Global.System.ComponentModel.Design.HelpKeyword("My.Log")> _
            Friend ReadOnly Property Log() As Global.Microsoft.Extensions.Logging.ILogger
                <Global.System.Diagnostics.DebuggerHidden()> _
                Get
                    Return _serviceProvider?.GetService(Of Global.Microsoft.Extensions.Logging.ILoggerFactory)()?.CreateLogger("MyApplication")
                End Get
            End Property
        #End If

        ' Existing properties for Computer, Application, User, Forms, and WebServices
        #If _MYCOMPUTERTYPE <> "" Then
        ...
        #If _MYWEBSERVICES = True Then
            ...
            Friend NotInheritable Class MyWebServices
                ...
                Public Overrides Function GetHashCode() As Integer
                    Return MyBase.GetHashCode
                End Function
                <Global.System.ComponentModel.EditorBrowsable(Global.System.ComponentModel.EditorBrowsableState.Never), Global.System.Diagnostics.DebuggerDelayed()> _
                Friend Overloads Function [GetType]() As Global.System.Type
        ...
        ' ThreadSafeObjectProvider class
        <Global.System.ComponentModel.EditorBrowsableAttribute(Global.System.ComponentModel.EditorBrowsableState.Never)> _
        ...
        ''' <summary>
        ''' Retrieves a configuration value by key, using the appropriate configuration system based on application type.
        ''' </summary>
        Friend Function GetConfigurationValue(key As String) As String
            #If _MYTYPE = "AspNetCore" Then
        ...
        ''' <summary>
        ''' Retrieves a connection string by name, using the appropriate configuration system based on application type.
        ''' </summary>
        Friend Function GetConnectionString(name As String) As String
            #If _MYTYPE = "AspNetCore" Then
                Return Configuration?.GetConnectionString(name)
            #Else
                Return Global.System.Configuration.ConfigurationManager.ConnectionStrings(name)?.ConnectionString
            #End If
        End Function
